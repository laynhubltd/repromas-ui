      ...
      <div style={{ padding: 24 }}>
        ...
        >
          ...
          >
            ...
            <li>Fill in course data starting from row 5 using the department dropdown.</li>
            <li>
              Do <strong>not</strong> modify the hidden <em>Reference</em> sheet or add/remove columns.
            </li>
        ...
        {/* Selected filename + Remove button */}
      ...
      >
        <DataLoader loading={isUploading}>
          <Button
            ...
            onClick={onUpload}
            block
            style={{ height: 48, fontWeight: token.fontWeightStrong }}
          >
            Upload
          </Button>
        </DataLoader>
