...
export type AdmissionCandidatePageAction =
  | { type: typeof AdmissionCandidatePageActionType.SetCycleId; cycleId: number | undefined }
  | { type: typeof AdmissionCandidatePageActionType.SetFirstNameSearch; value: string }
  | { type: typeof AdmissionCandidatePageActionType.SetDebouncedFirstName; value: string }
  | { type: typeof AdmissionCandidatePageActionType.SetLastNameSearch; value: string }
  | { type: typeof AdmissionCandidatePageActionType.SetDebouncedLastName; value: string }
  | { type: typeof AdmissionCandidatePageActionType.SetJambRegSearch; value: string }
  | { type: typeof AdmissionCandidatePageActionType.SetDebouncedJambReg; value: string }
  | {
      type: typeof AdmissionCandidatePageActionType.SetGenderFilter;
      value: CandidateGender | undefined;
    }
  | { type: typeof AdmissionCandidatePageActionType.SetStateFilter; value: number | undefined }
  | {
  ...
  | { type: typeof AdmissionCandidatePageActionType.SetFormModalOpen; open: boolean }
  | { type: typeof AdmissionCandidatePageActionType.SetMetadataModalOpen; open: boolean }
  | { type: typeof AdmissionCandidatePageActionType.SetMetadataTargetId; id: number | null }
  | { type: typeof AdmissionCandidatePageActionType.SetDrawerCandidateId; id: number | null }
  | { type: typeof AdmissionCandidatePageActionType.SetBulkUploadModalOpen; open: boolean }
  | { type: typeof AdmissionCandidatePageActionType.SetOfferTargetId; id: number | null }
  | { type: typeof AdmissionCandidatePageActionType.SetMatriculateTargetId; id: number | null }
