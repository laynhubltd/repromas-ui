...
export type ScoreSheetUploadModalProps = {
  open: boolean;
  onClose: () => void;
...
export function ScoreSheetUploadModal({
  open,
  onClose,
  selectedFile,
  isUploading,
    ...
    >
      <div style={{ padding: 24 }}>
        ...
        >
          ...
          >
            <li>
              Download the score sheet first using the{" "}
              <Typography.Text strong style={{ fontSize: token.fontSizeSM }}>
                Download Score Sheet
              </Typography.Text>{" "}
              button.
            </li>
            <li>Fill in scores in the unlocked cells only.</li>
            <li>
              Do <strong>not</strong> modify locked cells or add/remove columns.
            </li>
